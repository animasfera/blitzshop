...
import { CompletePurchasedItem, RelatedPurchasedItemModel, CompleteRefund, RelatedRefundModel } from "./index"
 ...
 */
export const RelatedItemToRefundModel: z.ZodSchema<CompleteItemToRefund> = z.lazy(() => ItemToRefundModel.extend({

...
-- CreateEnum
CREATE TYPE "OrderStatusEnum" AS ENUM ('PENDING', 'PAYMENT', 'PROCESSING', 'COMPLETED', 'CANCELLED', 'ON_HOLD', 'SHIPPED', 'DELIVERED', 'REFUND_REQUESTED', 'REFUND_REJECTED', 'REFUND_APPROVED', 'REFUNDED', 'PARTIALLY_COMPLETED');
...
-- CreateEnum
CREATE TYPE "InvoiceStatusEnum" AS ENUM ('PENDING', 'PARTIALLY_PAID', 'PAID', 'CANCELLED');
...
CREATE TABLE "Order" (
    ...
    "shippingDutyFee" INTEGER,
    "shippingInsuranceFee" INTEGER,
    "shippingPackageFee" INTEGER,
    "shippingAddressId" INTEGER,
    "shippingDutyPayment" "DutyPaymentEnum",
    "shippingInsurance" BOOLEAN NOT NULL DEFAULT false,

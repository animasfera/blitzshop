...
export function TransactionsFilter<S extends z.ZodType<any, any>>(props: FormPropsWithOnChange<S>) {
        ...
        <Form<S> {...props}>
          <FormSpy
            ...
            onChange={(data) => {
              ...
              if (data.values.type) {
                filterFormatted.type = data.values.type
              }
          ...
          <Flex flexDirection={["column"]}>
            ...
            <LabeledSelectField options={typeOptions} name={"type"} label={"Тип транзакции"} />
